...
const Scroller = () => {
  return (
    <section className="mx-auto mt-10 flex w-full max-w-2xl flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
